...
$stmt = $pdo->query("
    ...
    WHERE u.role = 'tutor' AND t.expertise <> '0.00'
    GROUP BY t.id
");
        ...
        <div class="sidebar">
            <div class="profile-dropdown" id="profileDropdown" style="position:relative;cursor:pointer;">
                ...
                <div>
                    ...
                    <div style="font-size:13px;color:var(--muted)">Active <?= htmlspecialchars(ucfirst($currentUser['role'])) ?></div>
                </div>
            </div>
        ...
        <div class="subjects-grid">
            <?php foreach ($tutors as $t): ?>
                <?php
                    ...
                    $subject_name = trim($subs[0] ?? 'Unknown');
                ?>
